...
from .views import home, profile, contactus,VerifyView, registration, RegisterView,renew_license, theorytest,upload_challan,challan_detail,challan_view,upload_video,download_pdf,generate_pdf,verify_license
from . import views
urlpatterns = [
